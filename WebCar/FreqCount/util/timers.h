...
*/
#if F_CPU == 16000000L
  #define TIMER0_OCR0A_1MS_VAL	124					// div 125
  #define TIMER0_TCCR0B_1MS_VAL	            (1<<CS22) | (1<<CS20)	// div 128
  #define TIMER0_OCR0A_2MS_VAL	124					// div 125
  #define TIMER0_TCCR0B_2MS_VAL	(1<<CS22) | (1<<CS21)			// div 256
  #define TIMER0_OCR0A_4MS_VAL	249					// div 250
  #define TIMER0_TCCR0B_4MS_VAL	(1<<CS22) | (1<<CS21)			// div 256
  #define TIMER0_OCR0A_8MS_VAL	124					// div 125
  #define TIMER0_TCCR0B_8MS_VAL	(1<<CS22) | (1<<CS21) | (1<<CS20)	// div 1024
#elif F_CPU == 8000000L
  #define TIMER0_OCR0A_1MS_VAL  124					// div 125
  #define TIMER0_TCCR0B_1MS_VAL (1<<CS22)				// div 64
  #define TIMER0_OCR0A_2MS_VAL  124					// div 125
  #define TIMER0_TCCR0B_2MS_VAL (1<<CS22) |             (1<<CS20)	// div 128
  #define TIMER0_OCR0A_4MS_VAL  124					// div 125
  #define TIMER0_TCCR0B_4MS_VAL (1<<CS22) | (1<<CS21)			// div 256
  #define TIMER0_OCR0A_8MS_VAL  249					// div 250
  #define TIMER0_TCCR0B_8MS_VAL (1<<CS22) | (1<<CS21)			// div 256
#elif F_CPU == 4000000L
  #define TIMER0_OCR0A_1MS_VAL  124					// div 125
  #define TIMER0_TCCR0B_1MS_VAL             (1<<CS21) | (1<<CS20)	// div 32
  #define TIMER0_OCR0A_2MS_VAL  124					// div 125
  #define TIMER0_TCCR0B_2MS_VAL (1<<CS22)				// div 64
  #define TIMER0_OCR0A_4MS_VAL  124					// div 125
  #define TIMER0_TCCR0B_4MS_VAL (1<<CS22) |             (1<<CS20)	// div 128
  #define TIMER0_OCR0A_8MS_VAL  124					// div 125
  #define TIMER0_TCCR0B_8MS_VAL (1<<CS22) | (1<<CS21)			// div 256
#elif F_CPU == 2000000L
  #define TIMER0_OCR0A_1MS_VAL  249					// div 250
  #define TIMER0_TCCR0B_1MS_VAL             (1<<CS21)			// div 8
  #define TIMER0_OCR0A_2MS_VAL  124					// div 125
  #define TIMER0_TCCR0B_2MS_VAL             (1<<CS21) | (1<<CS20)	// div 32
  #define TIMER0_OCR0A_4MS_VAL  124					// div 125
  #define TIMER0_TCCR0B_4MS_VAL (1<<CS22)				// div 64
  #define TIMER0_OCR0A_8MS_VAL  124					// div 125
  #define TIMER0_TCCR0B_8MS_VAL (1<<CS22) | (1<<CS21)			// div 128
#elif F_CPU == 1000000L
  #define TIMER0_OCR0A_1MS_VAL  124					// div 125
  #define TIMER0_TCCR0B_1MS_VAL             (1<<CS21)			// div 8
  #define TIMER0_OCR0A_2MS_VAL	249					// div 250
  #define TIMER0_TCCR0B_2MS_VAL	            (1<<CS21)			// div 8
  #define TIMER0_OCR0A_4MS_VAL	124					// div 125
  #define TIMER0_TCCR0B_4MS_VAL	            (1<<CS21) | (1<<CS20)	// div 32
  #define TIMER0_OCR0A_8MS_VAL	124					// div 125
  #define TIMER0_TCCR0B_8MS_VAL	(1<<CS22)				// div 64
#else
#error "Clock must be 16, 8, 4, 2 or 1 MHz"
#endif
...
static inline uint16_t timer_init(uint16_t msec)
{
	...
	if ((msec & 7) == 0) {
		gate_len = msec >> 3;
		OCR0A = TIMER0_OCR0A_8MS_VAL;
		startTCCR0B = TIMER0_TCCR0B_8MS_VAL;
	} else if ((msec & 3) == 0) {
		gate_len = msec >> 2;
		OCR0A = TIMER0_OCR0A_4MS_VAL;
		startTCCR0B = TIMER0_TCCR0B_4MS_VAL;
	} else if ((msec & 1) == 0) {
		gate_len = msec >> 1;
		OCR0A = TIMER0_OCR0A_2MS_VAL;
		startTCCR0B = TIMER0_TCCR0B_2MS_VAL;
	} else {
		gate_len = msec;
		OCR0A = TIMER0_OCR0A_1MS_VAL;
		startTCCR0B = TIMER0_TCCR0B_1MS_VAL;
	}
	TIFR0 = (1<<OCF0A);
	TCNT0 = 0;
	return gate_len;
